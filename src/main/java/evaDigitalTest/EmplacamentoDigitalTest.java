...
public class EmplacamentoDigitalTest {
    ...
    public void beforeEach(){
        LoginPage paginaDeLogin = new LoginPage("http://localhost:8080/eva/primeiroEmplacamentoDigital/emplacamentoDigital");
        paginaDeLogin.preencherFormularioDeLogin("Pedro.pereira","1234");
    }

    @AfterEach
    public void aftereEach(){
        captureScreenshot("C:\\TestePedro\\TestAutomation\\target\\screenshot\\"+"EmplacamentoDigital");
